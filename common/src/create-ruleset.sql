...
grant "{formatted_ruleset_role_migrator}" to "votebase_server";
...
grant "{formatted_ruleset_role_action}" to "votebase_server";
...
grant "{formatted_ruleset_role_view}" to "votebase_server";
