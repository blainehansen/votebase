...
export type FnAction<A extends JsonValue> = Readonly<{
	...
	func: (arg: A, userId: string | null) => Promise<ReplaceSelfStruct | void>,
}>
...
declare global {
	namespace votebase {
		...
		*/
		...
		function Action<Arg extends JsonValue>(name: string, func: (arg: Arg, userId: string | null) => Promise<ReplaceSelfStruct | void>): FnAction<Arg>
		/**
...
globalThis.votebase = {
	Action<Arg>(name: string, func: (arg: Arg, userId: string | null) => Promise<ReplaceSelfStruct | void>) {
